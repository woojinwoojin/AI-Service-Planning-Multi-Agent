...
| 항목 | 상태 | 해소 경로 |
|---|---|---|
| 출처 명시 | 더미라 미충족 | **실 LLM 에서는 충족** — 코드 변경 불필요 |
| AI 활용 로그 | 미충족 | 재료는 이미 있음(Artifact `owner_agent`·`depends_on`·`status`) — 형식 변환만 |
| 정량 주장의 가설·추정 표기 | 미충족 | 문서 조립 시 삽입 |
| 본문 30~50쪽 | 부분(약 1쪽) | KOSENA 7종 산출물 조립으로 해소 |
